 ...
 */
declare function createDiagram(options: object): LiveDiagram;
export { VERSION, LiveDiagram, createDiagram, defineLiveDiagram, readJsonAttr, hydrate, mountSpec, autoHydrate, legend, inspector, transport, toSVG, toPNG, download, encodeState, decodeState, shareUrl, applyShared, defaultTemplate, Emitter, StateStore, Timeline, Viewport, Overlay, mermaidRenderer, buildDefinition, nodeSyntax, tagNodes, tagEdges, resolveTheme, normalizeGraph, parseMermaid, parseStateDiagram, looksLikeMermaid, normalizeStates, normalizeEvents, diffSnapshots, styleFor, edgeStyleFor, parseStyle, isValidId, escapeLabel, nodeIds, edgeIds, ensureStyles, webSocketSource, eventSourceSource, pollSource, toTimelineEvents, graphFromEvents, fromGitHubActions, toStages, linkStages, stateOf, toId, GITHUB_STATES, DEFAULT_STATES, GROUP_STYLE, DIRECTIONS, SHAPES, CSS };
